...
$lang = [
    ...
    'usingDefaultCommandTemplate' => '$config[\'makeCommandTemplateLocation\'] has not been set in the ' . PHP_EOL . 'config file so Executive\'s default template will be used',
    'specifyMakeCommandNamespace' => "You must specify \$config['makeCommandNamespace'] = '\some\\name\space' in the config file",
    'specifyMakeCommandDestination' => "You must specify \$config['makeCommandDestination'] = '/path/to/dest/directory' in the config file",
